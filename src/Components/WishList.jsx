...
const WishList = (wishList) => {
    const { bookId, bookName, author, image, rating, category,
        tags, totalPages, publisher, yearOfPublishing } = wishList.wishList
    return (
        <div className="card border-2 border-gray-200 p-4 rounded-2xl lg:card-side grid grid-cols-1 md:grid-cols-3 rounded-2xl bg-base-100 my-20">
